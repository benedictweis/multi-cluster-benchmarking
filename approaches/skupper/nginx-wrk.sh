...
kubectl create namespace nginx-wrk --context "$CLUSTER_1_CONTEXT" --dry-run=client -o yaml | kubectl apply --context "$CLUSTER_1_CONTEXT" -f -
kubectl create namespace nginx-wrk --context "$CLUSTER_2_CONTEXT" --dry-run=client -o yaml | kubectl apply --context "$CLUSTER_2_CONTEXT" -f -
kubectl config set-context "$CLUSTER_1_CONTEXT" --namespace nginx-wrk
kubectl config set-context "$CLUSTER_2_CONTEXT" --namespace nginx-wrk
