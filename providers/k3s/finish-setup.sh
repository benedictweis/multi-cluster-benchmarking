...
yq -i '.clusters[0].context.cluster = "cluster-1"' "$KUBECONFIG_FILE_CLUSTER_1"
yq -i '.clusters[0].context.user = "user-1"' "$KUBECONFIG_FILE_CLUSTER_1"
...
yq -i '.clusters[0].context.cluster = "cluster-2"' "$KUBECONFIG_FILE_CLUSTER_2"
yq -i '.clusters[0].context.user = "user-2"' "$KUBECONFIG_FILE_CLUSTER_2"
